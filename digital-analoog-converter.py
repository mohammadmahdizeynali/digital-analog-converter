...
def reverse_signal(reverse_quantized_signal, max_signal):
    return reverse_quantized_signal * max_signal / 2**(v-1)


def DAC(bit_stream, refrence, v, max_signal, output_sound, samplerate):
    reverse_quantized_signal = reverse_bit_stream(bit_stream, refrence, v)
    reverse_signal_final = reverse_signal(reverse_quantized_signal, max_signal)
    wavfile.write(output_sound, samplerate, reverse_signal_final)
    return reverse_quantized_signal, reverse_signal_final

reverse_quantized_signal, reverse_signal_final =  DAC(bit_stream, refrence, v, max_signal, 'output_sound.wav', max_signal)
